...
- [ ] `core/src/memory/infrastructure/sqlite-memory-repository.test.ts` — integration, real sqlite
...
- [ ] `core/src/synthesis/application/engine.ts` — debounce loop, in-flight tracking, failure backoff
- [ ] `core/src/synthesis/infrastructure/sqlite-synthesis-repository.ts`
- [ ] `core/src/synthesis/infrastructure/claude-agent-runner.ts` — `AgentRunner` port impl
